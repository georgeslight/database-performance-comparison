        ...
        FROM
            (
                ...
                FROM
                    ...
                    LEFT JOIN qdaba.linie_lb llb ON llb.id_t_linie = l.id_t_linie AND p_2.betriebstag BETWEEN llb.gueltigkeit_start AND llb.gueltigkeit_end
                    LEFT JOIN qdaba.linienbuendel lb ON lb.id_t_lb = llb.id_t_lb AND p_2.betriebstag BETWEEN lb.gueltigkeit_start AND lb.gueltigkeit_end
            ) p_1
    ) p
